(function () {
  ...
  const onStorageChanged = async function (changes, areaName) {
    ...
    const {
      ...
      'mutualchecker.preferences.selectedBlog': selectedBlogChanges,
    } = changes;
    ...
    if (iconAfterChanges || selectedBlogChanges) {
      removeIcons();
      addIcons();
    }
  };
  ...
  const main = async function () {
    ...
    ({ iconAfter, selectedBlog } = await getPreferences('no_recommended'));
