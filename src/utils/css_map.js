...
/**
 * The dictionary, supplied by the Tumblr web platform API for third-party extensions, that translates source CSS class names as written internally by Tumblr developers (e.g. "container") to generated class names that appear in the DOM (e.g. ["Emdd2", "XKCjm"...]).
 *
 * Note: the same semantic source name can be used in multiple unrelated components (Tumblr uses scoped css), resulting in multiple generated class names that cannot be distinguished between using only this information.
