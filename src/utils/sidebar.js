...
/**
 * Add an interactable sidebar item control that will be visible in the page's right sidebar in the desktop Tumblr layout, or in the left mobile drawer in the tablet/mobile Tumblr layouts.
